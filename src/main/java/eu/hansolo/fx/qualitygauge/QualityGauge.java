 ...
 * Time: 06:52
 */
public class QualityGauge extends StackPane {
    ...
    private void initGraphics() {
        ...
        currentQualityText.setFont(Font.font( PREFERRED_HEIGHT * 0.14860681));
    ...
    private void addListener(int value, Path sec) {
        sec.addEventHandler(MouseEvent.MOUSE_PRESSED, event -> model.setValue(value));
    }
    ...
    private void updateValue() {
        ...
        if (value == 0) {
            ...
            currentQualityText.setFont(Font.font(height * 0.14860681));
